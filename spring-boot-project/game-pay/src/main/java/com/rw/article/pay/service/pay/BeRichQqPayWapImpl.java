 ...
 */
@Service
public class BeRichQqPayWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(BeRichQqPayWapImpl.class);


    private static final String PAY_TYPE = "qqweb";
