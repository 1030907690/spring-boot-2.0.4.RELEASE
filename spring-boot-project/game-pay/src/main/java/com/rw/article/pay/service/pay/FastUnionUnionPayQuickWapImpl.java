 ...
 */
@Service
public class FastUnionUnionPayQuickWapImpl implements IPayRealizeSv {
    private static final Logger log = LoggerFactory.getLogger(FastUnionUnionPayQuickWapImpl.class);


    private static final String PAY_TYPE = "8";
    @Resource
    ...
    public String callback(PayPlatform payPlatform, Map<String, String> params) {
        log.info("   FastUnionUnionPayQuickWapImpl callback params  [ {} ]  ", params.toString());
        //回调参数
