 ...
 */
@Service
public class AvenueThinkQuickWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(AvenueThinkQuickWapImpl.class);

    /**
     * 支付类型
     **/
    private final String PAY_TYPE = "kuaijie";
