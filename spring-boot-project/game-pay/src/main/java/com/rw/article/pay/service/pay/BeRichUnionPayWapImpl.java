 ...
 */
@Service
public class BeRichUnionPayWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(BeRichUnionPayWapImpl.class);


    private static final String PAY_TYPE = "ylpay";
    @Resource
