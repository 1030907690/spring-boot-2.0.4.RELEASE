 ...
 */
@Service
public class HuiBaoNetSilverHandlerImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(HuiBaoNetSilverHandlerImpl.class);
    ...
    public JsonObject gateway(PayPlatform payPlatform, RechargeOrder order, Map<String, String> params) {
        ...
        try {
            ...
            //银行类型，具体参考附录1,default为跳转到汇宝接口进行选择支付
            map.put("banktype", "default");
            //支付金额 转为 元
    ...
    public String callback(PayPlatform payPlatform, Map<String, String> params) {
        log.info("   HuiBaoNetSilverHandlerImpl callback params  [ {} ]  ", params.toString());
